...
1. Run the configured local cross-encoder against the persisted retrieval-quality fixture and
   ...
   Current status: `npm run smoke:rerank` => `RERANK_ENDPOINT_ERROR http://127.0.0.1:9000/v1/rerank: HTTP 404 Not Found`.
